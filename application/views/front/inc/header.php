...
<head>
    ...
    <title>Dnectar- Marketing Solutions</title>
...
<body>
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center">
            <a class="navbar-brand" href="#hero"><img src="<?php echo base_url(); ?>assets/images/logo.png" alt="image"></a>
            ...
            <a href="https://dnectar.trackier.com/register.html" class="get-started-btn scrollto">Get Started</a>
        </div>
    </header>